...
Para descargar el juego y poder correrlo se necesita descargar el archivo *picas.rar* que se encuentra en este repository, instarlar la librería [pillow](https://pillow.readthedocs.io/en/stable/) y tener algún programa que ejecute archivos *.py*.
